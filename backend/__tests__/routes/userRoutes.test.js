...
describe('Testing users module', () => {
  ...
  describe('GET /:id', () => {
    beforeEach(() => {
      varifyToken = sinon.stub(jwt, 'verify');
      findUserById = sinon.stub(User, 'findById');
      findUser = sinon.stub(User, 'find');
    });
    ...
    it('should return user by id', async () => {
      ...
      varifyToken.returns({ id: mockedUsers[0]._id });
      ...
      const token = '77fe3329-5563-476c-807e-0b383697bbc3'; // Assume this is a valid token
